...
pub fn render_process_details_modal(
    ...
    use library::interface::app::layout::centered_rect;
    let area = centered_rect(70, 60, area);
    let theme = library::interface::app::theme::get_theme(true, Color::Rgb(0, 245, 255));
...
pub fn render_help_modal(f: &mut Frame, parent: Rect) {
    use library::interface::app::layout::{centered_rect, format_help_row};
